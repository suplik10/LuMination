...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(exercisesDto != null){
            for (int i = 0; i < exercisesDto.size(); i++) {
                mItemArray.add(new Pair<>((long) i, exercisesDto.get(i).getName()));
            }
        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("List and GridF");
    }
    ...
    public List<ExerciseDto> getExercisesDto() {
        return exercisesDto;
    }

    public void setExercisesDto(List<ExerciseDto> exercisesDto) {
        this.exercisesDto = exercisesDto;
    }
}
